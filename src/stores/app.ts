...
export const userPrompt =
  atom<string>(`Act as an Accessibility Specialist. Your task is to write alternative text (alt-text) for the provided image to assist users of screen readers.
